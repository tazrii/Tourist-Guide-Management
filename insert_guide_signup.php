...
if(
   ...
   )
   {
     ...
     $sql2 = "INSERT INTO guide(guide_lastName, guide_firstName, guide_email, guide_phone, guide_address,  guide_password)
        ...
        if($is_inserted){
          ...
          echo "<script>
                ...
                window.location.href= 'guide_signup.php'
                </script>";
                exit;
        }
    }
